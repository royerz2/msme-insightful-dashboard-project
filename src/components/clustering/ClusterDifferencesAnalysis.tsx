...
const ClusterDifferencesAnalysis: React.FC<ClusterDifferencesAnalysisProps> = ({ data }) => {
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Cluster Differences Analysis (ANOVA)</CardTitle>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              ...
              <div className="text-sm text-gray-600">Total Variables Tested</div>
            </div>
            <div className="bg-green-50 p-4 rounded-lg text-center">
              <div className="text-2xl font-bold text-green-600">
                {anovaResults.filter(r => r.significant && !r.message).length}
              </div>
